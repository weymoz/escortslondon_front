...
import { groupedOptions } from "@functions/select-data";
...
const Hero = ({
  ...
  const onServicesPage = router.pathname === "/service";
    ...
    <section className={s.hero}>
      <div className={s.container}>
        <div className={s.titleWrapper}>
          <Title size="h1">{header || "London's Premium Escort Agency"}</Title>
        </div>
        <div className={s.filtersWrapper}>
          <p className={s.filtersLabel}>
            {searchTitle || "Search for the hottest escort girls in London"}
          </p>
